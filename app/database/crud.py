...
def get_new_characters(all_characters):
    """
...
def bulk_create_characters(characters_json_list):
    """
    ...
    """
    characters_json_list = get_new_characters(characters_json_list)
    db: Session = next(get_db())
    characters = []
    amount = 0
